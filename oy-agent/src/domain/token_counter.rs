...
pub struct TokenUsage {
    /// Total input (prompt) tokens sent to the AI provider (cumulative across all requests)
    pub input_tokens: u64,
    /// Total output (completion) tokens generated by the AI provider (cumulative)
